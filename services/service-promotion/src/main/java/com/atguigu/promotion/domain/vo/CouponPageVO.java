...
import io.swagger.v3.oas.annotations.media.Schema; // 注意：包路径已变更
import lombok.Data;

import java.time.LocalDateTime;

@Data
@Schema(description = "优惠券分页数据") // 替换原 @ApiModel
public class CouponPageVO {
    @Schema(description = "优惠券id，新增不需要添加，更新必填") // 替换原 @ApiModelProperty
    private Long id;
